...
-- Tiempo de generación: 03-09-2022 a las 23:19:32
...
INSERT INTO `products` (`id`, `name`, `marca`, `description`, `photo`, `stock`, `price`, `discount`, `created_at`, `updated_at`, `category_id`, `logic_delete`) VALUES
...
CREATE TABLE `users` (
  ...
  `logit_delete` tinyint(4) UNSIGNED NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `users` (`id`, `first_name`, `last_name`, `email`, `password`, `photo`, `created_at`, `updated_at`, `category_id`, `logit_delete`) VALUES
...
INSERT INTO `user_x_product` (`id`, `user_id`, `product_id`, `comments`, `comment_date`, `created_at`, `updated_at`) VALUES
(1, 1, 1, NULL, NULL, NULL, NULL),
(2, 1, 2, NULL, NULL, NULL, NULL),
(3, 1, 8, NULL, NULL, NULL, NULL),
(4, 3, 7, NULL, NULL, NULL, NULL),
(5, 2, 3, 'Exelente producto, muy recomendable', '2022-09-03 20:11:00', NULL, '2022-09-03 23:11:00'),
